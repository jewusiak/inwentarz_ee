    ...
    if (permissionStatus.isPermanentlyDenied) {
      await showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text(
              "Aby móc dodać załączniki, należy uzyskać dostęp do plików. Przejdź do ustawień i ręcznie włącz dostęp do plików."),
          actions: [
            TextButton(
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          title: Text("Potrzebujemy dostępu"),
          content: Text(
              "Aby móc dodać załączniki, należy uzyskać dostęp do plików."),
          actions: [
            TextButton(
                onPressed: () => Navigator.pop(context), child: Text("Anuluj")),
            TextButton(
